...
Route::middleware(['auth', 'campaign'])->group(function () {
    ...
    Route::get('api/call/status', [\App\Http\Controllers\Api\CallController::class, 'status'])->name('api.call.status')->middleware(['throttle:telephony-poll', 'log_throttle']);
    ...
    Route::get('api/telephony/active-lead', \App\Http\Controllers\Api\ActiveLeadController::class)->name('api.telephony.active-lead')->middleware(['throttle:telephony-poll', 'log_throttle']);
    ...
    Route::get('api/supervisor/agents', \App\Http\Controllers\Api\SupervisorAgentsController::class)->name('api.supervisor.agents')->middleware(['throttle:telephony-poll', 'log_throttle']);
