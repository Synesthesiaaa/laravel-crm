<div class="md-card p-4">
    <h3 class="text-sm font-semibold text-[var(--color-on-surface)] mb-3">Call Status Stats</h3>
    ...
    <pre class="text-xs whitespace-pre-wrap break-words bg-[var(--color-surface-2)] p-3 rounded border border-[var(--color-border)]"
         x-text="payloads.status?.data?.raw_response || payloads.status?.message || 'No data yet.'"></pre>
</div>
