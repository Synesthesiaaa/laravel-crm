    ...
    <div class="bg-white rounded-xl shadow border border-gray-100 overflow-hidden mb-6">
        ...
        <div class="p-6 border-b border-gray-100 bg-gray-50">
            ...
            <p class="text-xs text-gray-500 mb-3">
                Vicidial field examples: <code>first_name</code>, <code>last_name</code>, <code>address1</code>, <code>email</code>, <code>comments</code>.
            </p>
            <form method="POST" action="{{ route('admin.agent-screen.store') }}" class="flex flex-wrap gap-4 items-end">
                ...
                <div><label class="block text-xs font-bold text-gray-600 uppercase mb-1">Vicidial field (optional)</label><input type="text" name="vici_field" pattern="[a-zA-Z0-9_]+" class="px-3 py-2 border rounded" placeholder="first_name"></div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="text-left py-3 px-4 font-semibold text-gray-700">Vicidial Field</th>
                ...
                <tbody>
                    @forelse($fields as $f)
                        <tr class="border-b border-gray-100">
                            ...
                            <td class="py-3 px-4">{{ $f->vici_field ?: '—' }}</td>
                    ...
                    @empty
                        <tr><td colspan="5" class="py-8 px-4 text-center text-gray-500">No agent screen fields.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
