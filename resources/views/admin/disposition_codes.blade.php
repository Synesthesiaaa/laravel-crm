...
@section('title', 'Disposition Codes')
@section('header-icon')<x-icon name="tag" class="w-5 h-5 text-[var(--color-primary)]" />@endsection
@section('header-title', 'Disposition Codes')
