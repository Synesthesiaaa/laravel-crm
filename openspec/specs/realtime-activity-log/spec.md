...
Give Super Admins a protected, terminal-style view of meaningful system and configuration changes with redacted before/after values and realtime delivery backed by polling fallback.
