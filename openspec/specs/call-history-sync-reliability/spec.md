...
Keep background Call History synchronization consumable by the configured workers and recover safely from stale synchronization state while exposing actionable, sanitized health diagnostics.
