# data-master-desktop-table Specification

## Purpose

Define the desktop Data Master table behavior for fitting all fields to the viewport while keeping long result sets vertically scrollable.
