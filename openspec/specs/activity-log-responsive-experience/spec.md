# Activity Log Responsive Experience

## Purpose

Keep the protected Activity Log readable and operable across phone, tablet, and desktop widths while preserving its realtime, polling, filtering, and redaction behavior.
