...
Provide a centralized, secure, cached company branding configuration for the CRM so Super Admins can update the company name, logo, and favicon and have the identity appear consistently across guest and authenticated experiences.
