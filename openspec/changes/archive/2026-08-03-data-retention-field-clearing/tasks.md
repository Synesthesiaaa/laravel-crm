...
- [x] 1.3 Extend the retention form request and controller tests for mode validation, eligible field validation, policy upsert, and clearing selections when switching to whole-record mode.
